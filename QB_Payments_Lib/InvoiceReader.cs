...
namespace QB_Payments_Lib
{
    ...
    {
        public static Invoice QueryInvoiceByCustomerNameAndMemo(string customerName, string memo)
        {
            ...
            try
            {
                ...
                BuildInvoiceQueryRq(requestMsgSet, customerName, memo);
        ...
        static void BuildInvoiceQueryRq(IMsgSetRequest requestMsgSet, string customerName, string memo)
        {
